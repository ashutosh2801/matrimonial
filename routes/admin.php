...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Educational
    Route::resource('/educational', 'EducationalController');
    Route::post('/educational/status', 'EducationalController@updateStatus')->name('educational.status');
    Route::get('/educational/destroy/{id}', 'EducationalController@destroy')->name('educational.destroy');

    // Professional
    Route::resource('/professional', 'ProfessionalController');
    Route::post('/professional/status', 'ProfessionalController@updateStatus')->name('professional.status');
    Route::get('/professional/destroy/{id}', 'ProfessionalController@destroy')->name('professional.destroy');
