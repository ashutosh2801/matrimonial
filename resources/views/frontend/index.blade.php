                    ...
                    @if (!Auth::check() && get_setting('show_homepage_slider_registration') == 'on')
                        <div class="offset-xxl-2 offset-xl-1 col-lg-6 col-xxl-5">
                            <div class="card">
                                ...
                                <div class="tab-content" id="myTabContent" style="min-height: 443px;">
                                    <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                                        <div class="mb-4 mt-4 text-center">
                                            <h2 class="h3 text-primary mb-0">{{ translate('Login to your account') }}</h2>
                                            <p>{{ translate('Fill out the login credentials to get started') }}.</p>
                                        </div>
