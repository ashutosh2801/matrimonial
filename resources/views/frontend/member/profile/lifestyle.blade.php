            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="drink" required>
                        ...
                        <option value="no" @if($user_drink ==  'no' || $user_drink ==  '') selected @endif >{{translate('No')}}</option>
                        @error('drink')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </select>
            ...
            <div class="form-group row"> --}}
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="smoke" required>
                        ...
                        <option value="no" @if($user_smoke ==  'no' || $user_smoke ==  '') selected @endif >{{translate('No')}}</option>
                        @error('smoke')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </select>
