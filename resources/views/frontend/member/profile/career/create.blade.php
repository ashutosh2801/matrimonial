<form action="{{ route('career.store') }}" method="POST">
    ...
    <div class="modal-header">
        <h5 class="modal-title h6">{{translate('Add New Occupation')}}</h5>
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('Package')}}</label>
            <div class="col-md-9">
                <input type="number" name="package" class="form-control" placeholder="{{translate('Package')}}" required>
            </div>
        </div>
        {{-- <div class="form-group row">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">{{translate('Add New Occupation')}}</button>
    </div>
</form>
