        ...
        <div class="card-body">
            <form action="{{ route('member.introduction.update', $member->member->id) }}" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-md-12 col-form-label">{{translate('Profile summary')}}</label>
                    <div class="col-md-12">
                        <textarea type="text" name="introduction" class="form-control" rows="6" placeholder="{{translate('Profile summary')}}" required>{{ $member->member->introduction }}</textarea>
                    </div>
                </div>
