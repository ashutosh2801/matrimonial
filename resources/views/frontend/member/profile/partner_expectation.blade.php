        ...
        <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <div class="">
                        @php
                            $height = !empty($member->partner_expectations->height) ? $member->partner_expectations->height : " . ";
                            $height = explode(".", $height);
                        @endphp
                        <select class="col-md-6 form-control aiz-selectpicker" name="partner_height_in_feet" >
                            <option value="">{{translate('Select One')}}</option>
                            @for ($i=1; $i<8; $i++)
                                <option @if(trim($height[0]) == $i) selected @endif value="{{$i}}">{{$i}} ft</option>
                            @endfor
                        </select>
                        <select class="col-md-5 form-control aiz-selectpicker" name="partner_height_in_inch" >
                            <option value="">{{translate('Select One')}}</option>
                            @for ($i=1; $i<12; $i++)
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="pertner_education" data-live-search="true">
                        <option value="">{{translate('Select One')}}</option>
                        @foreach ($educational as $edu)
                            <option value="{{$edu->id}}" @if($edu->id == $pertner_education) selected @endif> {{ $edu->name }} </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    @php $pertner_profession = !empty($member->partner_expectations->profession) ? $member->partner_expectations->profession : "" @endphp
                    <select class="form-control aiz-selectpicker" name="pertner_education" data-live-search="true">
                        <option value="">{{translate('Select One')}}</option>
                        @foreach ($professional as $edu)
                            <option value="{{$edu->id}}" @if($edu->id == $pertner_profession) selected @endif> {{ $edu->name }} </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="partner_country_id">{{translate('Preferred Residence Country')}}</label>
