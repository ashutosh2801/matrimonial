                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @can('show_educational')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('educational.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['educational.edit']) }}">
                                            <span class="aiz-side-nav-text">{{ translate('Education') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('show_professional')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('professional.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['professional.edit']) }}">
